...
<head>
	...
	<style>
		#pahang-logo {
			width: 2.5cm;
			height: 3.13cm;
			background: url(https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Coat_of_arms_of_Pahang.svg/363px-Coat_of_arms_of_Pahang.svg.png);
		...
		#banner-jaip {
			width: 3.15cm;
			background: url({{ asset("assets/img/banner_jaip.jpg") }});
			background-repeat: no-repeat;
			background-size: cover;
			margin: auto;
			margin-top: 0px
...
<table class="body">
	<tr>
		<td class="center" aling="center" valign="top">
			<center>
				@yield('content')
			</center>
		</td>
